...
You can :
   - ⛏️ Mint (1:1 less fee) $BRIDGE
   - 🔥 Burn $BRIDGE and get back your ETH 1:1 
   - 📤 Transfer to other chain (Base, Linea, Mainnet, Optimism) using LayerZero technology 

All of this on our website [http://www.bridge-lz.finance/](http://www.bridge-lz.finance/).
...
*Don't forget that $BRIDGE is always 1:1 with gas chain so this is stability pool ⚖️
